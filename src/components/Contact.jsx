          ...
          <Col>
            <div className='card contact-card text-dark bg-light mb-3'>
              <div className='card-body'>
                ...
                <a href={profile.github} target='_blank'>{profile.github_user}</a>
              </div>
            </div>
          </Col>
        </Row>
          ...
          <Col>
            <div className='card contact-card text-dark bg-light mb-3'>
              <div className='card-body'>
                ...
                <a href={profile.linkedin} target='_blank'>{profile.linkedin_user}</a>
              </div>
            </div>
          </Col>
          <Col>
            <div className='card contact-card text-dark bg-light mb-3'>
              <div className='card-body'>
                ...
                <a href={profile.website} target='_blank'>{profile.website_name}</a>
              </div>
            </div>
          </Col>
        </Row>
